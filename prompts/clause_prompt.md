...
3. **Update and report state** (narratively, not as raw numbers):
   ...
   - "You sense growing resentment in ❄️ #workshop-general" (morale down)
...
- ⭐⭐⭐ "Exceeds Expectations" - "The board is impressed. Keep this up."
- ⭐⭐ "Meets Expectations" - "Acceptable. You're still employed."
- ⭐ "Development Needed" - "HR has scheduled a coaching session."
...
- **❄️ #workshop-general**: Emoji chaos with buried wisdom
...
- **Player is abusive to NPCs**: Morale drops sharply. ❄️ #workshop-general fills with 👀 emoji. Cupid (Director of Elf Relations) sends a concerned message.
